...
public class RegistrationController {
	...
	public String showMyLoginPage(Model theModel) {
		...
		theModel.addAttribute("gameTodoeyAdmin", new GameTodoeyAdmin());
	...
	public String processRegistrationForm(
				@Valid @ModelAttribute("gameTodoeyAdmin") GameTodoeyAdmin theGameTodoeyAdmin, 
				BindingResult theBindingResult, 
				Model theModel) {
						
		String userName = theGameTodoeyAdmin.getUserName();
        ...
        List<GrantedAuthority> authorities = AuthorityUtils.createAuthorityList("ROLE_NORMAL_ADMIN");
